...
bug1: 文档生成时，app应该根据用户输入的文档生成需求来通过LLM生成大纲，而不是给一个固定的但是相关性很差的大纲模版。比如“向王芳写一封邮件，汇报最近一周在做什么产品，产品有什么价值，为啥要做，预期收益，现在做到了什么程度。“，app给的大纲“s1
概述
↑
↓
+
...
×
s3
总结” 毫无意义，应该根据用户输入的文档生成需求来通过LLM生成大纲。
